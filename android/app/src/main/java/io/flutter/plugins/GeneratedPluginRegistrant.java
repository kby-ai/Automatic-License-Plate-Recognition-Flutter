...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new com.kbyai.alprsdk_plugin.AlprsdkPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin alprsdk_plugin, com.kbyai.alprsdk_plugin.AlprsdkPlugin", e);
    }
    try {
